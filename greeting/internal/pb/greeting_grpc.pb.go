...
func (c *greetingServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponce, error) {
...
func (UnimplementedGreetingServiceServer) SayHello(context.Context, *HelloRequest) (*HelloResponce, error) {
